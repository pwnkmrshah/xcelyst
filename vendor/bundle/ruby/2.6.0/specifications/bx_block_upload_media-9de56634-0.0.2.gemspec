# -*- encoding: utf-8 -*-
# stub: bx_block_upload_media-9de56634 0.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_upload_media-9de56634".freeze
  s.version = "0.0.2"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_upload_media".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockUploadMedia".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bx_block_custom_form-63cd533b>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<bx_block_custom_ads-e8d68990>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<bx_block_custom_form-63cd533b>.freeze, [">= 0"])
      s.add_dependency(%q<bx_block_custom_ads-e8d68990>.freeze, [">= 0"])
