module BxBlockCreateIndex
	class DatabaseUserJob < BxBlockBulkUpload::ApplicationJob 

		def perform(ids)
            model_to_search = BxBlockDatabase::TemporaryUserDatabase
            records = BxBlockDatabase::TemporaryUserDatabase.where(id: ids)
