# -*- encoding: utf-8 -*-
# stub: bx_block_admin 0.0.10 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_admin".freeze
  s.version = "0.0.10"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_admin".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockAdmin".freeze
