# -*- encoding: utf-8 -*-
# stub: bx_block_custom_user_subs 0.0.7 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_custom_user_subs".freeze
  s.version = "0.0.7"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_custom_user_subs".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockCustomisableUserSubscriptions".freeze
