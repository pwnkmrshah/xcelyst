# -*- encoding: utf-8 -*-
# stub: aws-sdk-ssmincidents 1.9.0 ruby lib

Gem::Specification.new do |s|
  s.name = "aws-sdk-ssmincidents".freeze
  s.version = "1.9.0"
  ...
  s.date = "2021-12-21"
  s.description = "Official AWS Ruby gem for AWS Systems Manager Incident Manager (SSM Incidents). This gem is part of the AWS SDK for Ruby.".freeze
  s.email = ["aws-dr-rubygems@amazon.com".freeze]
  s.homepage = "https://github.com/aws/aws-sdk-ruby".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "AWS SDK for Ruby - SSM Incidents".freeze
