# -*- encoding: utf-8 -*-
# stub: bx_block_sorting-a08a7b91 0.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_sorting-a08a7b91".freeze
  s.version = "0.0.2"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_sorting".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockSorting".freeze
