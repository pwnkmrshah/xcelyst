# -*- encoding: utf-8 -*-
# stub: bx_block_scheduling-d1f08754 0.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_scheduling-d1f08754".freeze
  s.version = "0.0.2"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_scheduling".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockScheduling".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bx_block_calendar-4836ef12>.freeze, ["= 0.0.3"])
      ...
      s.add_dependency(%q<bx_block_calendar-4836ef12>.freeze, ["= 0.0.3"])
