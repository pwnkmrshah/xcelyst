# -*- encoding: utf-8 -*-
# stub: bx_block_filter_items-b1be1f37 0.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_filter_items-b1be1f37".freeze
  s.version = "0.0.2"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_filter_items".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockFilterItems".freeze
