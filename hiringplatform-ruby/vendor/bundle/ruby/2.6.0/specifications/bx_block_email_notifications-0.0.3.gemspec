# -*- encoding: utf-8 -*-
# stub: bx_block_email_notifications 0.0.3 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_email_notifications".freeze
  s.version = "0.0.3"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_email_notifications".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockEmailNotifications".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bx_block_notifications-a22eb801>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<bx_block_notifications-a22eb801>.freeze, [">= 0"])
