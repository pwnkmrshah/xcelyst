...
$(document).ready(function() {
	$("#sover_automat_dropdown").hide()
	$('#skills_ajax').on('click', function(e) {
		e.preventDefault();
		let edutions = $('#edutions_dropdown').val()
		let job_title = $('#jd_title_dropdown').val()
		let skill_name = $('#skiils_dropdown').val()
		let industries = $('#industries_dropdown').val()
		let mangement = $('#mangement_dropdown').val()
		let jd_id = $('#jd_dropdown').val()
		let client_id = $('#client_dropdown').val()
		...
		$.ajax({
			...
			type: "post",
			data: {skill_name: skill_name, job_title: job_title, edutions: edutions, industries: industries, mangement: mangement,shortlist_users: localStorage.shortlist_array.split(","), jd_id: jd_id, client_id:  client_id },
	...
	$('#sover_automat').on("click", function(e){
		e.preventDefault();
		$("#sover_automat_dropdown").toggle()
	})
